...
It deliberately has no page scraping, provider detection, keys, signing, messaging, or external writes. Unknown selectors remain unknown. The extension is useful before it is trusted.
